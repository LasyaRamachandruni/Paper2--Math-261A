...
-   `Data_Value_Type`: crude or age-adjusted estimate indicator

For this study, six county-level measures were extracted from the PLACES dataset:

-   **DIABETES** — estimated percentage of adults who have been told they have diabetes; used as the response variable.

-   **OBESITY** — estimated percentage of adults with a body mass index (BMI) of 30 or higher.

-   **LPA** — estimated percentage of adults reporting no leisure-time physical activity.

-   **BPHIGH** — estimated percentage of adults who have been told they have high blood pressure.
